...
public class User_3 extends JFrame implements ActionListener {
    ...
    public User_3(String uname, String servername) throws Exception {
        super(uname);
    ...
    public static void main(String[] args) {
        ...
        try {
            new User_3( userName ,servername);
        } catch(Exception ex) {
            ex.printStackTrace();
        }
    }
